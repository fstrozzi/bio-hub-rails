module ActiveMessaging
  ...
  def self.load_processors(first=true)
    ...
    application_file = "#{APP_ROOT}/app/processors/application.rb" 
    logger.debug "ActiveMessaging: Loading #{application_file}" if first 
    load application_file if File.exist?(application_file)
